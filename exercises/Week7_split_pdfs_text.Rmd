...
file_path <- "../exercises/assets/extracted_text/kemi_text.txt"
...
```{r}
kemi_index <- read_lines("../exercises/assets/extracted_text/kemi_extracted_1.txt")
...
write_csv(final_data, "assets/final_data.csv")
...
system("pdftotext /Users/robwells/Code/CompText_Jour/exercises/assets/pdfs/kemi.PDF ../exercises/assets/extracted_text/kemi3.txt")
```
