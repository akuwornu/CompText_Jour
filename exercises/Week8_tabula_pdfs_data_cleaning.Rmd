...
We can't resist the temptation to open a crystal ball on the election. Let's calculate a new column describing the percent turnout by mail ballot by county We will use mutate to divide the total_received by total_sent
