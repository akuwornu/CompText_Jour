...
#To view days with most calls
Mostcalls_day

#The day with the most 311 calls was 8/15/2019 with 232 calls
```
...
```{r}
# Identify the top 5 days with the most calls
Top_5 <- day_calls %>% 
  slice_max(n, n = 5)
...
#The top 5 days with the most calls are 8/15/19, 4/19/18, 4/18/16, 3/28/18, 5/8/18.
```
...
#The top 5 days with fewer calls are 3/31/16, 6/30/19, 6/9/18, 1/6/19, 8/18/18.
```
